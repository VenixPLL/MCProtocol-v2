...
public class MathHelper {
    ...
    public static float getDistance(final Position pos1, final Position pos2) {
        final float var2 = (float) (pos1.getX() - pos2.getX());
        final float var3 = (float) (pos1.getY() - pos2.getY());
        final float var4 = (float) (pos1.getZ() - pos2.getZ());
        return sqrt_float(var2 * var2 + var3 * var3 + var4 * var4);
    }
