...
public class JsonToNBT {
    ...
    static Any func_150316_a(String p_150316_0_, String p_150316_1_) throws NBTException {
        ...
        if (p_150316_1_.startsWith("{")) {
            ...
            for (var5 = new Compound(p_150316_0_); p_150316_1_.length() > 0; p_150316_1_ = p_150316_1_.substring(var3.length() + 1)) {
            ...
            for (var2 = new List(p_150316_0_); p_150316_1_.length() > 0; p_150316_1_ = p_150316_1_.substring(var3.length() + 1)) {
